...
```
cd extensions
git clone https://github.com/bonfire-networks/bonfire_rss.git {your-extension-name-here}
cd {your-extension-name-here} 
```
- Rename all the modules names to match your extension name:
    - Find & replace Bonfire.Rss -> Bonfire.YourExtensionName 
    - Find & replace bonfire_rss -> bonfire_your_extension_name
- Rename the `bonfire_rss.exs` config file to match your extension name `bonfire_your_extension_name.exs`
...
- Add `use_if_enabled(Bonfire.Rss.Web.Routes)` in your app's `Router` module
